  ...
  return (
    <div className="relative bg-background overflow-hidden w-full">
      <div className="w-full">
        <div className="relative z-10 pb-8 bg-background sm:pb-16 md:pb-20 lg:w-1/2 lg:pb-28 xl:pb-32">
          <main className="mx-auto w-full px-4 sm:px-6 lg:px-8 pt-10 sm:pt-12 md:pt-16 lg:pt-20">
